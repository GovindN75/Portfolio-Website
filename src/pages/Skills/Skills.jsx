...
const Skills = () => {
  return (
    <div className="pt-3 pb-3" id="skills">
      <h1 className="text-center font-details-b pb-4" style={{color: "#99774f"}}>My Skillset</h1>
      <CardDeck>
        <Row className="d-flex justify-content-around">
          <Col md={4}>
            <Card className="focus mt-2 mb-2" style={{backgroundColor: "#f0f8ff"}}>
              <Card.Body>
              ...
              <Card.Body>
                ...
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  {skills.misc.map((skill, index) => (
                    <span className="p-2" key={index}>
                      <a className="text-dark text-decoration-none" href={skill.link} target="_blank" rel="noopener noreferrer" style={{color: "#99774f"}}>
                        <Image src={skill.img} alt={skill.img_alt} rounded className="image-style m-1"></Image> {skill.name}
                      </a>
                    </span>
                  ))}
